...
public final class ObjectMessageListener implements MessageListener {
	...
	private static final Logger LOG = Logger.getLogger(ObjectMessageListener.class.getName());
	...
	public final void onMessage(final Message message) {
		if (message instanceof ObjectMessage) {
			...
			try {
				...
				LOG.warning("Failed to extract message object, message ignored!"+jmse.getMessage());
			}
		}
	}
