...
public interface IStoreInventoryManager extends Remote {
	...
	/**
	 * Orders products for a store. A separate product order is created for each
	 * supplier, with the ordering date set to the date of method execution.
	 * Without using transaction mechanism specified by
	 * {@link ITransactionContext}.
	 * <p>
	 * Used for realization of UC 3.
	 * 
	 * @param complexOrder
	 ...
	 */
	List<ComplexOrderTO> orderProducts(ComplexOrderTO complexOrder,
			IData data) throws RemoteException;
	 ...
	 * @return
	 */
	ProductWithStockItemTO changePrice(IData data ,StockItemTO stockItemTO);
