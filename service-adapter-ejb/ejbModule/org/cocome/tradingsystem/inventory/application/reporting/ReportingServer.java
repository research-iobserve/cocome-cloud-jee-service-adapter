 ...
 */
public final class ReportingServer extends UnicastRemoteObject implements IReporting {
	 ...
	 * transaction mechanism specified by {@link ITransactionContext}
	 * 
	 * @param enterprise
	 * @param pctx
	 * @return
	 */
	@Override
	public ReportTO getEnterpriseDeliveryReport(TradingEnterprise enterprise, IPersistenceContext pctx) {
		Formatter report = new Formatter();
		this.appendReportHeader(report);
		this.appendDeliveryReport(enterprise, pctx, report);
		this.appendReportFooter(report);
		return this.createReportTO(report);
	}
	...
	@Override
	public ReportTO getStoreStockReport(Store store, IPersistenceContext pctx) {
//		final Store store = ReportingServer.this.storeQuery.queryStoreById(storeId, pctx);
		Formatter report = new Formatter();
		this.appendReportHeader(report);
		this.appendStoreReport(store, pctx, report);
		this.appendReportFooter(report);
		return this.createReportTO(report);
	}
	...
	@Override
	public ReportTO getEnterpriseStockReport(TradingEnterprise enterprise, IPersistenceContext pctx) {
		Formatter report = new Formatter();
		this.appendReportHeader(report);
		this.appendEnterpriseReport(enterprise, pctx, report);
		this.appendReportFooter(report);
		return this.createReportTO(report);
	}
