 ...
 * @version 2.0
 */
@XmlRootElement(name = "ProductMovement")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "ProductMovement", propOrder = { "__originStore", "__destinationStore","__productAmounts"})
public class ProductMovementTO implements Serializable {

	private static final long serialVersionUID = 6086062214137352097L;

	@XmlElement(name="OriginStore")
	private StoreTO __originStore;

	@XmlElement(name="DestinationStore")
	private StoreTO __destinationStore;

	@XmlElementWrapper(name="ProductAmounts")
