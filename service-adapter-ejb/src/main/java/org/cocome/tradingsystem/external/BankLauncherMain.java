...
public final class BankLauncherMain {
	...
	private static final Logger LOG = Logger.getLogger(BankLauncherMain.class.getName());
	...
	private static void startBank(final String registryHost, final String registryPort, final String bankName) {
		...
		LOG.info("Starting bank " + description);
		...
		try {
			...
			LOG.severe("Failed to start bank " + description);
