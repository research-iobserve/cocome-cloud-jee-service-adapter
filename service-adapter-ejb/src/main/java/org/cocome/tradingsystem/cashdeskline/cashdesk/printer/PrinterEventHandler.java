...
final class PrinterEventHandler
	...
	private static final Logger LOG =
			Logger.getLogger(PrinterEventHandler.class.getName());
	...
	public void onEvent(final RunningTotalChangedEvent event) {
		...
		LOG.info("\trunningTotal: " + runningTotal);
	...
	private void logUnexpectedState() {
		LOG.info("\tevent ignored - not expected in state " + this.controllerState);
	}
