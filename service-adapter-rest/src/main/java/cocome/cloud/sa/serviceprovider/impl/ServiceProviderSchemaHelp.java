...
public final class ServiceProviderSchemaHelp {
	...
	public static void getSchemas(final HttpServletRequest request,
		...
		try {
			...
			final Table<String> t1 = new Table<>();
			...
			final Table<String> t2 = new Table<>();
			...
			final Table<String> t3 = new Table<>();
			...
			final Table<String> t4 = new Table<>();
			...
			final Table<String> t5 = new Table<>();
			...
			final Table<String> t6 = new Table<>();
			...
			final Table<String> t7 = new Table<>();
			...
			final Table<String> t8 = new Table<>();
			...
			final Table<String> t9 = new Table<>();
			...
			final Table<String> t10 = new Table<>();
			...
			final Table<String> t11 = new Table<>();
			...
			final Table<String> t12 = new Table<>();
			...
			final InputStream resourceContent = ctx
